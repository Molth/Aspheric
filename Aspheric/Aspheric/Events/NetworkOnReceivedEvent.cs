...
namespace Erinn
{
    ...
    public readonly unsafe struct NetworkOnReceivedEvent : IDisposable
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Add(OnReceivedDelegate @delegate)
        {
        ...
        public void Adds(Type type)
        {
            ...
            {
                var attribute = methodInfo.GetCustomAttribute<OnReceivedAttribute>();
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Add(delegate* managed<in NetworkPeer, in NetworkPacketFlag, in Span<byte>, void> @event) => _events.Add((nint)@event);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Remove(delegate* managed<in NetworkPeer, in NetworkPacketFlag, in Span<byte>, void> @event) => _events.Remove((nint)@event);
        ...
        public void Invoke(in NetworkPeer peer, in NetworkPacketFlag flags, in byte* buffer, in int length)
        {
            ...
            {
                var @event = (delegate* managed<in NetworkPeer, in NetworkPacketFlag, in Span<byte>, void>)value;
                @event(peer, flags, span);
            }
        }
        ...
        private static bool IsValid(MethodInfo methodInfo)
        {
            ...
            return parameters.Length == 3 && parameters[0].ParameterType == typeof(NetworkPeer).MakeByRefType() && parameters[0].IsIn && parameters[1].ParameterType == typeof(NetworkPacketFlag).MakeByRefType() && parameters[1].IsIn && parameters[2].ParameterType == typeof(Span<byte>).MakeByRefType() && parameters[2].IsIn;
        }
